...
Scripts Description
script1.sh — System Identity Report (shows kernel, user, uptime)
script2.sh — FOSS Package Inspector (checks if git is installed)
script3.sh — User Input Script (takes input from user)
script4.sh — File Checker (checks if file exists)
script5.sh — Simple Calculator (performs arithmetic operations)
